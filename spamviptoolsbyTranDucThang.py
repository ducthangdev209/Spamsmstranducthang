...
class SPAM:
 ...
 ██████╔╝╚██████╔╝╚█████╔╝  ░░░██║░░░██║░░██║██║░░██║██║░╚███║╚██████╔╝
 ╚═════╝░░╚═════╝░░╚════╝░  ░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚══╝░╚═════╝░
Profile FB cá nhân: https://www.facebook.com/dthangg.developer.xyz/
 Github: https://github.com/ducthangdev209 vào git để mình thường xuyên share tools nhé
 Tiktok:https://www.tiktok.com/@dthangg.developer.xyz
 T.me: https://t.me/ducthangdev2
 Zalo: 039822341x
\033[1;39m- - - - - - - - - - - - - - - - - - - - * SPAM SMS (Tin nhắn) * - - - - - - - - - - - - - - - - - - - - -
                               \n\n'''
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("!",f"XIN VUI LÒNG NHẬP SỐ ĐIỆN THOẠI SPAM: "))
...
if __name__ == "__main__":
    try:
        ...
        time.sleep(3)
        sys.exit('\n'+SPAM().format_print('*', 'tool của Thắng:)'))
